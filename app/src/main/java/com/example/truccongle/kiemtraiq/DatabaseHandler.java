...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String dbPath = "/data/data/com.example.truccongle.kiemtraiq/databases/KiemTraIQ.sqlite";
    private static final String dbName = "KiemTraIQ.sqlite";
